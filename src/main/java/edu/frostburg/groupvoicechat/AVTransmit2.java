...
public class AVTransmit2 {
    ...
    private String start()
        ...
        for (MediaType mediaType : mediaTypes) {
            ...
            MediaDevice device
                    = mediaService
                    .getDefaultDevice(mediaType, MediaUseCase.CALL);
            ...
            switch (device.getMediaType()) {
                ...
                case VIDEO:
                    ...
                    /*
                     * The dymanic RTP payload type numbers are usually
                     * negotiated in the signaling functionality.
                     */
